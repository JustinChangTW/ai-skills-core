...
- 適合：the user provides or points to media and asks to transcribe, cut, subtitle, preview, or export a vertical short.
- 不適合：for environment-only setup or generic Premiere Pro or CapCut help.
...
```text
$video-short-editor 請依我的目標與現有資料完成任務，並列出需要我確認的事項。
```
