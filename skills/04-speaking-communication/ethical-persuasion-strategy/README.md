...
在使用者要設計說服策略、提案溝通或反對點 FAQ 時使用。常見觸發像「讓客戶買單」「推動內部採用」「整理 objections」。輸出可執行訊息策略與倫理護欄；不做黑暗模式或不透明操弄。

## 基本資料

- Skill ID：`ethical-persuasion-strategy`
...
```text
$ethical-persuasion-strategy 請依我的目標與現有資料完成任務，並列出需要我確認的事項。
```
