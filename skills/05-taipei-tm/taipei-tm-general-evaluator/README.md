...
準備台北市健言社整場TM的十五分鐘總評。Use when user 要統整主席、講員群、個別講評與計時流程。Do not use for 單一講員講評、撰稿、主持或計時。成功結果是有證據、有優先順序且不重複個別講評的整場改進方案。

## 基本資料

- Skill ID：`taipei-tm-general-evaluator`
- 分類：`05-taipei-tm`
- 版本：`2026.8.16`
...
- 適合：user 要統整主席、講員群、個別講評與計時流程
- 不適合：for 單一講員講評、撰稿、主持或計時
- 預期成果：有證據、有優先順序且不重複個別講評的整場改進方案
...
```text
$taipei-tm-general-evaluator 請依我的目標與現有資料完成任務，並列出需要我確認的事項。
```
