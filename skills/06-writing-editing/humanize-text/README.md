...
在使用者要把 AI 味太重、翻譯腔或過度制式的內容改寫成人類自然語氣時使用。常見觸發像「潤稿貼文」「重寫 Email」「把講稿寫自然一點」。保留事實與專有名詞；不用來偽造經驗或繞過 AI 偵測。

## 基本資料

- Skill ID：`humanize-text`
...
```text
$humanize-text 請依我的目標與現有資料完成任務，並列出需要我確認的事項。
```
