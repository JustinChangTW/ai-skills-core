...
在使用者要把零散想法推進成長文初稿、審稿與完稿流程時使用。常見觸發像「幫我寫長文」「做多輪審稿」「把草稿修成可發表文章」。輸出 draft、review 與修訂記錄；不適合只要一小段文案或 PRD。

## 基本資料

- Skill ID：`longform-writing-process`
...
```text
$longform-writing-process 請依我的目標與現有資料完成任務，並列出需要我確認的事項。
```
